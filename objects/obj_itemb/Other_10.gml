...
if global.turn = 0
{
    ...
    if obj_pep_battle.itemid = 4 //Nut
    {
        ...
        if global.GHP > global.maxGHP
            global.MLP = global.maxGHP;
        global.nuts -= 1;
        instance_create(obj_pep_battle.xstart,obj_pep_battle.ystart,obj_healpointsbattle);
        ID = instance_create(obj_gustavob.xstart,obj_gustavob.ystart,obj_healpointsbattle);
        with ID pos = 1;
    }
...
if global.turn = 1
{
    ...
    if obj_gustavob.itemid = 8 //Star Candies
    {
        global.GHP += global.maxGHP;
        global.GBP += global.maxGBP
        global.starcandies -= 1;
        instance_create(obj_gustavob.xstart,obj_gustavob.ystart,obj_healpointsbattle);
        ID = instance_create(obj_gustavob.xstart+32,obj_gustavob.ystart+32,obj_healpointsbattle);
        with ID showbp = 1;
    }
