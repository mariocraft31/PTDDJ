...
stancey = y;
image_speed = .35;
stance = 1; //Stance that gustavo takes
control = 1; //If gustavo can move
battleblock = 0; //What battle block is above gustavo's head
...
0 is standby while it is gustavo's turn
...
glitchfix = false; //Fix a glitch with gustavo's animation walking back after attack
name = "Gustavo";
ID = 0;
/* */
/*  */
