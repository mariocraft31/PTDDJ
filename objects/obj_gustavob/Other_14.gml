...
//Select and use item
if global.Pdead > 0 && itemid = 13 && global.oneups > 0
{
    targetchoose = 2;
    phase = 3;
    audio_play_sound(snd_confirm,0,0);
}
else if global.Pdead > 0 && itemid = 14 && global.oneupsupers > 0
{
    targetchoose = 2;
    phase = 3;
    //audio_play_sound(snd_confirm,0,0);
}
/*else if global.Pdead = 0 && itemid = 13 && global.oneups > 0
    audio_play_sound(snd_incorrect,0,0);
else if global.Pdead = 0 && itemid = 14 && global.oneupsupers > 0
    audio_play_sound(snd_incorrect,0,0);*/
else if global.Pdead > 0
{
    targetchoose = 1;
    phase = 3;
    audio_play_sound(snd_confirm,0,0);
